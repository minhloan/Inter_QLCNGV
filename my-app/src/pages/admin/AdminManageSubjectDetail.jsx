...
const AdminManageSubjectDetail = () => {
  ...
  const systemDisplay = {
    ACN_PRO_OV7096: "ACN Pro OV 7096",
    ARENA_OV6899: "Skill Arena OV 6899",
    APTECH_OV7091: "Skill Aptech OV 7091",
    APTECH_OV7195: "Skill Aptech OV 7195",
  };

  const formatSystem = (system) =>
    systemDisplay[system] || system || "Unknown";
